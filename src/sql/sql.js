module.exports = sql = {
  test: `SELECT * FROM users LEFT JOIN progress ON (users.user_id = progress.progress_user_id) LEFT JOIN goals ON (progress.progress_goal_id = goals.goal_id)`,
  createUser: `INSERT INTO users (user_id, display_name, user_handle, auth) VALUES ($1, $2, $3, $4)`,
